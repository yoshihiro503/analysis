...
HB.builders Context R E of TopologicalLmod_isEvt R E.
  Definition entourage : set_system (E * E). Admitted.
  Lemma entourage_filter : Filter entourage. Admitted.
...
Lemma regular_Uniform_isEvt (R : numFieldType) : Uniform_isEvt R R^o.
Proof.
split.

Search "cont" (GRing.add).
